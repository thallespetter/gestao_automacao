/* Service Worker – orcamento v1 */
const CACHE_NAME = 'orcamento-redes-v1';
const CACHE_FILES = ['./orcamento_redes.html','./manifest_orcamento.json','./icon_orcamento_192.png','./icon_orcamento_512.png'];
